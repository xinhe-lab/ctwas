...
We require first running the data preprocessing and harmonization steps before running cTWAS main analysis. Please follow the tutorial [Preparing cTWAS input data]() to prepare cTWAS input data.

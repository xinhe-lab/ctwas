...
It also computes enrichment (log scale), and its standard error. We provided two options to assess the statistical significance of enrichment: "G-test" (`enrichment_test = "G"`, default option), or Fisher's exact test (`enrichment_test = "fisher"`).

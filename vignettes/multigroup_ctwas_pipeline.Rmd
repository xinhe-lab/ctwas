...
It returns a data frame containing z-scores for the molecular traits.
...
```{r expand_regionlist, eval=FALSE}
...
finemap_regions_file <- file.path(outputdir, paste0(outname, ".ctwas.res.RDS"))
...
## Summarizing and interpreting cTWAS output

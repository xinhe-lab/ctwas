...
For those merged regions, we will expand those regions with full SNPs. 
We rerun finemapping for the merged regions,
and then update the finemapping results for those merged regions. 
```{r, eval=FALSE}
# Expand those merged regions with full SNPs

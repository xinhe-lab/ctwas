...
<span style="color: red;">NOTE: Consider adding an option to impute only specific genes in the imputation function, or to impute only genes in specific regions. This will make the code more accessible for user who want to run cTWAS as a single locus with fixed parameters. </span>

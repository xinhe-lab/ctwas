...
We have the reference variant information from UK Biobank European population in [b38](https://uchicago.box.com/s/t089or92dkovv0epkrjvxq8r9db9ys99) and [b37](https://uchicago.box.com/s/ufko2gjagcb693dob4khccqubuztb9pz).
...
*Note*: we limit variants in the processed weights to the preprocessed variants in `z_snp` (by setting `gwas_snp_ids = z_snp$id`), so please run preprocess_z_snp() before running preprocess_weights(). 

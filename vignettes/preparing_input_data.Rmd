...
On the University of Chicago RCC cluster, the b38 LD reference is available at `/project2/compbio/UKB_LD_REF/UKB_LDR_0.1_b38/` and the b37 LD reference is available at `/project2/compbio/UKB_LD_REF/UKB_LDR_0.1_b37/`.
...
On the University of Chicago RCC cluster, the reference variant information is available at `/project2/compbio/UKB_LD_REF/ref_snp_info/`.

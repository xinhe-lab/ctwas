---
title: "Summarizing and post-processing cTWAS results"
author: "Kaixuan Luo, Sheng Qian"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Summarizing and post-processing cTWAS results}
...
We use gene annotations from Ensembl database (EnsDb.Hsapiens.v86). Please choose the Ensembl database for your specific data. 
```{r load_ens_db}
...
# select PIP > 0.8
finemap_sig_res <- finemap_res[finemap_res$type!="SNP" & finemap_res$susie_pip > 0.8,]

head(finemap_sig_res[order(-finemap_sig_res$susie_pip),])
```

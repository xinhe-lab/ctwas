...
We could use the `combine_gene_pips()` function to compute gene PIPs across different types of molecular traits. Here we use `group_by = "gene_name"`, because molecular traits are mapped to their corresponding genes by the "gene_name" column in `mapping_table`.  

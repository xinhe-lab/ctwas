...
The locus plot above shows the whole region. We could zoom in a region of interest by specifying the `locus_range` argument. In the example below, we zoom in the region, color the p-value track by correlations with the focal gene, and color the PIP track by credible sets.
...
For the "no-LD" version, we could still make the locus plot. The difference is that it could not limit results to credible sets, and could not color the data points by correlations or credible set information.

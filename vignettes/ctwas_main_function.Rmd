...
-   There are several options for how to handle the prior effect size parameters by specifying the `group_prior_var_stucture`. See the section "Estimating parameters" for more details about these settings.

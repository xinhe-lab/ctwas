...
It is critical that the genome build (e.g. hg38) of the LD reference matches the genome build used to train the prediction models.  You can use the function `get_predictdb_genome_build()` to read the genome build of PredictDB weight file:

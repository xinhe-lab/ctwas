...
Here we check regions with total non-SNP PIPs > 0.8:
...
selected_region_ids <- selected_nonSNP_PIP_df[selected_nonSNP_PIP_df$nonSNP_PIP
 > 0.8, "region_id"]
```
...
res <- diagnose_ld_mismatch_susie(z_snp, region_ids, LD_info, snp_info, gwas_n, 

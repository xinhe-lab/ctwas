...
located in the RCC cluster of UChicago:  `/project2/compbio/UKB_LD_REF/UKB_LDR_0.1_b38/`. 
...
mediated by molecular traits and variants, which can be visualized using a pie chart.
...
To process the fine-mapping results, we first map introns to genes and add gene annotations to cTWAS results. 
We provide a  `mapping_table`  for PredictDB expression and slicing data [here](https://uchicago.box.com/s/gx7raqf5c9jp6tgvm5tpc2ej7zr6bnxz). 

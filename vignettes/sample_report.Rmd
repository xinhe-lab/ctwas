...
- `thin = 1` (default option): uses all SNPs to estimate parameters and screen regions.
- `group_prior_var_structure = "shared_all"` (default option): Allows all groups to share the same variance parameter.
...
results_dir <- file.path("/project/xinhe/xsun/multi_group_ctwas/examples/results_predictdb_4301010/", trait)

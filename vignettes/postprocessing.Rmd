...
This returns a list of problematic SNPs (diagnostic test `p-value < 5e-6`, by default), flipped SNPs, and the test statistics of `kriging_rss` function from [SuSiE-RSS][susierss_diagnostic]. 

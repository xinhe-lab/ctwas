...
high_PIP_finemap_gene_res <- subset(finemap_res, group != "SNP" & susie_pip > 0.5 & cs_index != 0)
...
We can replace the fine-mapping results for the merged regions:
...
We can replace the fine-mapping results for the problematic regions:

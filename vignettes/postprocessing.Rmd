...
GWAS sample size (`gwas_n`), preprocessed GWAS z-scores (`z_snp`), prediction models of genes (`weights`), and the reference data: including information about regions (`region_info`), reference variant list (`snp_map`) and reference LD (`LD_map`). 

...
pars <- ctwas_rss(z_snp, z_gene, ld_pgenfs, ld_exprfs, ld_regions_custom = regionsfile, trim_z_prop = 1, trim_z_value = 0, max_snp_region = 100, outputdir = outputdir, outname = "test_ss", ncore = 1)
```

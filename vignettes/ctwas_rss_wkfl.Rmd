...
LD reference should contain all SNPs given in z score. SNP ID and LD reference SNP ID should have the same meaning. weights and LD refernce ID should have same meaning and ref/alt allele info needs to match. All coordinates are in hg19.
...
ctwas_rss(zdf, ld_pgenfs, ld_exprfs, ld_regions = "EUR", thin = 1, outputdir = outputdir, outname = "z", ncore = 14)
```

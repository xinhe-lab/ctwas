...
+ `screen_res`: screening regions results, including the data of all SNPs and molecular traits of the selected regions, and a data frame with non-SNP PIPs for all regions.

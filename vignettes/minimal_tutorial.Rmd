...
Installation of `ctwas` takes 1-2 minutes if the dependent packages have already been installed. 
Running this tutorial with the included sample data takes 2-3 minutes. 
...
We have the reference variant information from UK Biobank European population available [here](https://uchicago.box.com/s/w3j3w49a5y5p1rhlti95u324g8ro6kkn). They are also available on the University of Chicago RCC cluster at `/project2/compbio/UKB_LD_REF/ref_snp_info/`. 

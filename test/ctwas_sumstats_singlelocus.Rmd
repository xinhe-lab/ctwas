...
```{r}
setwd("/project2/xinhe/kevinluo/cTWAS/ctwas_tutorial/")
knitr::opts_knit$set(root.dir = "/project2/xinhe/kevinluo/cTWAS/ctwas_tutorial/")
```
...
weight <- "/project2/xinhe/kevinluo/cTWAS/ctwas_tutorial/weights_nolnc/mashr_Liver_nolnc.db"
file.exists(weight)

...
test_that("merge_region_data and finemapping without LD works", {
  ...
  precomputed_merged_region_data <- readRDS("LDL_example.merged_region_data.RDS")
  precomputed_finemap_merged_regions_res <- readRDS("LDL_example.merged_region_finemap_noLD_res.RDS")
...
test_that("merge_region_data and finemapping with LD works", {
  ...
  precomputed_merged_region_data <- readRDS("LDL_example.merged_region_data.RDS")
  precomputed_merged_region_finemap_res <- readRDS("LDL_example.merged_region_finemap_res.RDS")
  ...
  capture.output({
    merged_region_finemap_res <- finemap_regions(merged_region_data,
                                                 use_LD = TRUE,
  ...
  expect_equal(merged_region_finemap_res, precomputed_merged_region_finemap_res)

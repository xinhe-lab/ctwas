...
test_that("expand_region_data works", {
  ...
  expected_selected_region_data <- ctwas_res$screen_res$selected_region_data
  selected_region_data <- region_data[names(expected_selected_region_data)]
  ...
  expect_equal(selected_region_data, expected_selected_region_data)

...
## New version: multi-group cTWAS (M-cTWAS)

We have updated the `ctwas` package. The new version, multi-group cTWAS (or M-cTWAS), can analyze GWAS and molecular QTL data from multiple modalities and contexts. 

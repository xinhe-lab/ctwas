...
ldref_dir <- "/project2/xinhe/1kg/1000G_Phase3_plink/b37/1000G_EUR_phase3_b37"
genotype_files <- file.path(ldref_dir, paste0("1000G_EUR_phase3_b37_chr", 1:22, ".bed"))

# PLINK reference variant information files in .pvar or .bim format.
varinfo_files <- file.path(ldref_dir, paste0("1000G_EUR_phase3_b37_chr", 1:22, ".bim"))
...
# specify output
outputdir <- "/project2/xinhe/shared_data/cTWAS/LD_files/1000G_EUR_phase3_b37"
